    ...
    if uid == "so100":
        robot_config = SO100FollowerConfig(
            ...
            cameras={
                ...
                # "so100": OpenCVCameraConfig(index_or_path=4, fps=30, width=640, height=480),
            },
            # for intel realsense camera users you need to modify the serial number or name for your own hardware
            # cameras={
            #     "base_camera": RealSenseCameraConfig(serial_number_or_name="125322060037", fps=30, width=1280, height=720)
            # },
            id="seg_sim2real",
        )
