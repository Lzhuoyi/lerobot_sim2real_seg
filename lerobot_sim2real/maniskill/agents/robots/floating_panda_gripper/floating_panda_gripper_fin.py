...
class FloatingPandaGripperFin(BaseAgent):
    ...
    urdf_path = f"{PACKAGE_ASSET_DIR}/robots/panda_fin/panda_fin_gripper.urdf"  # You can use f"{PACKAGE_ASSET_DIR}" to reference a urdf file in the mani_skill /assets package folder
    urdf_config = dict(
        _materials=dict(
