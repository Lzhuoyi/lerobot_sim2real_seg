...
python lerobot_sim2real/scripts/eval_ppo_rgb.py --env_id="SO100GraspCube-v1" --env-kwargs-json-path=env_config.json --checkpoint=models/xlerobot/final_ckpt.pt --no-continuous-eval --control-freq=15
"""
